...
const MENU = [
  {
    ...
    items: [
      ...
      { name: 'Kopi Susu Halu',  desc: 'Our signature milk coffee',          price: 14 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cokelat Susu',    desc: 'Dark cocoa, steamed milk',             price: 14 },
      { name: 'Taro Milk',       desc: 'Creamy purple yam blend',              price: 15 },
      { name: 'Milo Dinosaur',   desc: 'Classic nostalgia in a cup',           price: 14 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Roti Pisang',     desc: 'Banana bread, house-made',             price: 12 },
      { name: 'Kue Sus',         desc: 'Choux pastry, vanilla cream',          price: 8  },
      { name: 'Toast Alpukat',   desc: 'Sourdough, smashed avo',               price: 18 },
    ],
  },
]
